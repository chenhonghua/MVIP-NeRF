...
def raw2outputs_with_normal(raw, z_vals, rays_o, rays_d, raw_noise_std=0, white_bkgd=False, pytest=False, need_alpha=False,
                detach_weights=False):
    """Transforms model's predictions to semantically meaningful values.
    Args:
        pts: 
    ...
    return rgb_map, disp_map, acc_map, weights, depth_map, last#, normal_map
